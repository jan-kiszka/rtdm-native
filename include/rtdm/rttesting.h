...
typedef struct rttst_rtdmtest_config {
...
#define RTTST_RTIOC_RTDMTEST_MUTEX_TEST \
	_IOW(RTIOC_TYPE_TESTING, 0x70, struct rttst_rtdmtest_config)

#define RTTST_RTIOC_RTDMTEST_MUTEX_TIMEDTEST \
	_IOW(RTIOC_TYPE_TESTING, 0x71, struct rttst_rtdmtest_config)

#define RTTST_RTIOC_RTDMTEST_MUTEX_DESTROY \
	_IO(RTIOC_TYPE_TESTING, 0x72)

#define RTTST_RTIOC_RTDMTEST_MUTEX_GETSTAT \
	_IOR(RTIOC_TYPE_TESTING, 0x73, struct rttst_rtdmtest_config)

#define RTTST_RTIOC_RTDMTEST_EVENT_SIGNAL \
	_IO(RTIOC_TYPE_TESTING, 0x80)

#define RTTST_RTIOC_RTDMTEST_EVENT_WAIT \
	_IO(RTIOC_TYPE_TESTING, 0x81)

#define RTTST_RTIOC_RTDMTEST_EVENT_TIMEDWAIT \
	_IOW(RTIOC_TYPE_TESTING, 0x82, struct rttst_rtdmtest_config)

#define RTTST_RTIOC_RTDMTEST_EVENT_DESTROY \
	_IO(RTIOC_TYPE_TESTING, 0x83)

#define RTTST_RTIOC_RTDMTEST_SEM_UP \
	_IO(RTIOC_TYPE_TESTING, 0x90)

#define RTTST_RTIOC_RTDMTEST_SEM_DOWN \
	_IO(RTIOC_TYPE_TESTING, 0x91)

#define RTTST_RTIOC_RTDMTEST_SEM_TIMEDDOWN \
	_IOW(RTIOC_TYPE_TESTING, 0x92, struct rttst_rtdmtest_config)

#define RTTST_RTIOC_RTDMTEST_SEM_DESTROY \
	_IO(RTIOC_TYPE_TESTING, 0x92)
