...
#ifndef _XENO_NUCLEUS_TRACE_NATIVE_H
#define _XENO_NUCLEUS_TRACE_NATIVE_H
...
#define xntrace_max_begin(v)
#define xntrace_max_end(v)
#define xntrace_max_reset()
#define xntrace_user_start()
#define xntrace_user_stop(v)
#define xntrace_user_freeze(v, once)
#define xntrace_special(id, v)
#define xntrace_special_u64(id, v)
#define xntrace_pid(pid, prio)
#define xntrace_panic_freeze()
#define xntrace_panic_dump()
...
#endif /* !_XENO_NUCLEUS_TRACE_NATIVE_H */
